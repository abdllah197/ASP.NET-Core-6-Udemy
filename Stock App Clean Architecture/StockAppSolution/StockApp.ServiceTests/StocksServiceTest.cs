...
namespace Tests.ServiceTests
{
    public class StocksServiceTest
    {
        ...
        private readonly ILogger<StocksBuyOrderService> _buyLogger;
        private readonly ILogger<StocksSellOrderService> _sellLogger;

        private readonly Mock<IStocksRepository> _stocksRepositoryMock;
        private readonly Mock<ILogger<StocksBuyOrderService>> _buyLoggerMock;
        private readonly Mock<ILogger<StocksSellOrderService>> _sellLoggerMock;
        ...
        public StocksServiceTest(ITestOutputHelper testOutputHelper)
        {
            ...
            _buyLoggerMock = new Mock<ILogger<StocksBuyOrderService>>();
            _sellLoggerMock = new Mock<ILogger<StocksSellOrderService>>();
			_stocksRepository = _stocksRepositoryMock.Object;
            _buyLogger = _buyLoggerMock.Object;
            _sellLogger=_sellLoggerMock.Object;
			_stocksBuyOrderService = new StocksBuyOrderService(_stocksRepository, _buyLogger);
            _stocksSellOrderService = new StocksSellOrderService(_stocksRepository, _sellLogger);
        ...
        public async Task GetAllBuyOrders_WithFewBuyOrder_ToBeSuccessful()
        {
            ...
            List<BuyOrderResponse> buyOrdersRespnseFromGet = await _stocksBuyOrderService.GetBuyOrders();
        ...
        public async Task GetAllSellOrders_WithFewBuyOrder_ToBeSuccessful()
        {
            ...
            List<SellOrderResponse> sellOrdersRespnseFromGet = await _stocksSellOrderService.GetSellOrders();
